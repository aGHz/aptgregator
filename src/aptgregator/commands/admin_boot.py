...
from aptgregator.util import ansi
_ansi = {
    'mdl': ansi.green,
    'cls': ansi.blue,
    'obj': ansi.yellow,
...
#print 'from aptgregator import {obj}settings{r}'.format(**_ansi)
#from aptgregator import settings
#print 'from aptgregator.model import session as {obj}db{r}'.format(**_ansi)
#from aptgregator.model import session as db
